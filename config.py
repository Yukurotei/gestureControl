...
class ConfigManager:
    ...
    DESCRIPTIONS = {
        "THUMB_INDEX_THRESHOLD": "Distance for thumb-to-index touch (left click). Lower = fingers must be closer.",
        "THUMB_MIDDLE_THRESHOLD": "Distance for thumb-to-middle touch (snap initiation). Lower = fingers must be closer.",
        "THUMB_PINKIE_THRESHOLD": "Distance for thumb-to-pinkie touch (right click). Lower = fingers must be closer.",
    ...
    DISPLAY_NAMES = {
        "THUMB_INDEX_THRESHOLD": "Thumb-Index Threshold",
        "THUMB_MIDDLE_THRESHOLD": "Thumb-Middle Threshold",
        "THUMB_PINKIE_THRESHOLD": "Thumb-Pinkie Threshold",
